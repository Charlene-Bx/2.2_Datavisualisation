...
// Parcourir le DOM pour retrouver le contenu general et les tableaux de données. - - - - - - - - - - - - - - - - - - - - - - - - - - - -
let content= document.querySelector("#mw-content-text");

let allTable= document.querySelectorAll("table");
let tableOne= allTable[0];
let tableTwo= allTable[1];

//Creer les elements graphique - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
let graphOne= document.createElement("canvas");                                 //Avec  la Librairy Chart
graphOne.id="myChart";
graphOne.width="400";
graphOne.height="400";

let graphTwo= document.createElement("div");                                    //Avec la librairy UIChart
graphTwo.id="chart-area";



// A J O U T E R   L E S   G R A P H I Q U E S   D A N S   L E   D O M  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
content.appendChild(graphOne);
content.appendChild(graphTwo);

// I N S E R E R    L E S   G R A P H I Q U E   A  U   D E S S U S   D E S   T A B L  E A U X - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
content.insertBefore(graphOne, tableOne);
content.insertBefore(graphTwo, tableTwo);
...
// * * * GRAPHIQUE UN
let trTableOne= Array.from(tableOne.querySelectorAll("tbody tr"));              //selectionner tous les TR et les regrouper en tableau
